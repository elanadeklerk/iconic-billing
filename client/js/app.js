...
const App = {
  ...
  clearAdminForm(){
    ['adminEditUserId','adminDrName','adminDrEmail','adminDrPassword','adminSheetId','adminAppsScript','adminGoogleKey','adminAnthropicKey','adminCollectionsId'].forEach(id=>{const e=App.el(id);if(e)e.value='';});
  ...
  bindAll() {
    ...
    on('sidebarCollections',   'click',()=>{ App.closeSidebar(); App.openCollections(); });
